...
import { connect, hireFarmers, hatchEggs, sellEggs, copyRef, approveMiner, updateBuyPrice } from './main_eth';
...
const faqData = [
  {
    title: `What is the Lemonad Stand?`,
    content: 
    <div
      id="faq-list-1"
      class="collapse show"
    ...
    >
      <p>
        The Lemonad Stand is a decentralized application built on the Binance Smart Chain. 
  ...
  },
  {
    ...
    content: <div
        ...
        data-bs-parent=".faq-list"
      >
        <p> The Lemonad Stand has several anti-dumping and anti-whale measures in place to ensure the longevity of the project. 
  ...
  return (
    <div>
      <div id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-lg-between">
          <div class="logo me-auto me-lg-0">
              ...
              <div>
                <span class="busd">Lemonad Stand</span>
              </div>
          </div>
      ...
      <div id="banner">
        <div id="wrapper">
          ...
          {/* <a href="https://bit.ly/3ME8Y1D" target="_blank"> */}
            <img class="banner-img" src="./assets/img/friends.jpg" alt="N.A.L.A. Apparel"/>
          {/* </a> */}
          </div>
        </div>
      </div>
                    ...
                    <div class="row example">
                      <div class="col-lg-8">
                        <div style={{lineHeight:"1.8"}}>
                          ...
                          <div>
                            <div>1<span class="busd">BUSD</span> = <span id="example-miners"> 0 </span> Farmers</div>
                            <div>
                    ...
                    <div>
                      ...
                      <div class="btn-container" style={{marginTop:"35px"}}>
                        <div style={{marginBottom:"20px"}}>
                          <button class="btn glow-on-hover" id="withdraw" onClick={ sellEggs } role="button">
                            Harvest Crops
                        ...
                        <div>
                          <button class="btn glow-on-hover" id="reinvest" onClick={ hatchEggs } role="button">
                            Hire More Farmers
                            <span class="compound">
      ...
      <footer id="footer">
        <div class="container">
          <div class="copyright">
            © Copyright <strong><span>The Lemonad Stand Team</span></strong>. All Rights Reserved
          </div>
        </div>
      </footer>
    </div>
